<?php
/**
 * Test de l'intégration SMS HSMS pour les bordereaux UNIPALM
 */
...
// Inclure la fonction d'envoi SMS pour bordereau
...
<head>
    ...
    <title>Test SMS Bordereau UNIPALM</title>
            ...
            <div class="col-md-10">
                <div class="glass-card p-4">
                    <h2 class="text-white text-center mb-4">
                        <i class="fas fa-file-invoice me-2"></i>Test SMS Bordereau UNIPALM
                    </h2>
                    ...
                    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                        ...
                        if (!empty($numero) && !empty($nom) && !empty($prenom) && !empty($numero_bordereau)) {
                            echo '<div class="alert alert-info"><i class="fas fa-spinner fa-spin me-2"></i>Test d\'envoi SMS bordereau en cours...</div>';
                            
                            $resultat = envoyerSMSBordereau($numero, $nom, $prenom, $numero_bordereau, $montant_total, $nombre_tickets);
                    ...
                    <div class="row">
                            ...
                            <form method="POST" class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" id="numero_bordereau" name="numero_bordereau" 
                                           value="<?= htmlspecialchars($_POST['numero_bordereau'] ?? 'BDR-20251213-180000-1234') ?>" required>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="montant_total" name="montant_total" 
                                           value="<?= htmlspecialchars($_POST['montant_total'] ?? '150000') ?>" min="0">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="nombre_tickets" name="nombre_tickets" 
                                           value="<?= htmlspecialchars($_POST['nombre_tickets'] ?? '5') ?>" min="0">
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="message-preview" id="messagePreview">
                                UNIPALM - Nouveau Bordereau

Bonjour Jean KOUAME,

Un nouveau bordereau a été généré pour vous :

📋 Numéro : BDR-20251213-180000-1234
🎫 Tickets : 5
💰 Montant : 150 000 FCFA

Consultez votre espace agent pour plus de détails.
...
Équipe UNIPALM
                    ...
                    <div class="mt-4">
                        <div class="glass-card p-3">
                            ...
                            <div class="text-white-50 small">
                                ...
                                <p><strong>Message type :</strong> Notification de nouveau bordereau</p>
                                <p><strong>Déclenchement :</strong> Automatique lors de la création d'un bordereau</p>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function updatePreview() {
            const nom = document.getElementById('nom').value || 'KOUAME';
            const prenom = document.getElementById('prenom').value || 'Jean';
            const numero_bordereau = document.getElementById('numero_bordereau').value || 'BDR-20251213-180000-1234';
            const montant_total = parseInt(document.getElementById('montant_total').value) || 150000;
            const nombre_tickets = parseInt(document.getElementById('nombre_tickets').value) || 5;
            
            const message = `UNIPALM - Nouveau Bordereau
